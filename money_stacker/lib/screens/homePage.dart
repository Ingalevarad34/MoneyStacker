...
//     // Fallback to 'guest' if not signed in. Change behavior here if you want to force sign-in.
...
//                     .ref(
//                       "expenses/$_userId/$currentYear/${selectedMonthIndex + 1}/items",
//                     )
//                     .onValue,
...
//                   final Map<dynamic, dynamic> dataMap = rawData is Map
//                       ? rawData
//                       : {};

//                   List<Map<String, dynamic>> recentTxs = dataMap.entries.map((
//                     entry,
//                   ) {
//                     final tx = Map<String, dynamic>.from(entry.value as Map);
//                     tx['id'] = entry.key;
//                     return tx;
//                   }).toList();

//                   final now = DateTime.now();
//                   recentTxs = recentTxs.where((tx) {
